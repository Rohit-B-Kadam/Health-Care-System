...
if(request.getMethod().equalsIgnoreCase("GET"))
{
	...
	try
	{
		...
		//check this query
		sql = "select DP.*, P.name, P.email from Doctor_Appointments as DP , Patients as P where DP.patient_id = P.patient_id  and appointment_date > '"+dateCheck+"' ORDER BY appointment_date,appointment_time";
